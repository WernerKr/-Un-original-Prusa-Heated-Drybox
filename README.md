...
- Invalid values ​​(85°C or -127°C and now too >150°C) are displayed as 0.0 °C/F but are not transmitted to Home Assistant.

#### The esp32 3.1.1 board library is needed!. The newer esp32 3.2.0 board library is causing errors. 
...
![drybox_graph](https://github.com/user-attachments/assets/57c977a6-f2c3-4c00-a06f-d0d6ff1cb4cb)
![Drybox2_graph](https://github.com/user-attachments/assets/fd4046ba-71b6-4693-aa11-d28a50dbf49f)
